...
function SuccessContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-surface">
      <div className="w-20 h-20 rounded-full bg-brand-100 flex items-center justify-center text-4xl mb-6 shadow-card">
        ✓
      </div>
      ...
      <p className="text-gray-500 text-sm mt-3 max-w-xs">{t('success.subtitle')}</p>
      <div className="flex flex-col gap-3 w-full max-w-xs mt-8">
        ...
        <Link href={customerPath('/')} className="text-sm text-gray-500 mt-2 font-medium">
          {t('success.home')}
        </Link>
      </div>
    </div>
